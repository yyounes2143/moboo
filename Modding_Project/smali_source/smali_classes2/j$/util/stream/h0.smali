...
.method public static synthetic j(Ljava/util/stream/LongStream;)Lj$/util/stream/LongStream;
    ...
    iget-object p0, p0, Lj$/util/stream/i0;->a:Lj$/util/stream/LongStream;
...
.method public final synthetic iterator()Lj$/util/PrimitiveIterator$OfLong;
    ...
    .line 0
    :cond_0
    instance-of v1, v0, Lj$/util/v;

    if-eqz v1, :cond_1

    check-cast v0, Lj$/util/v;

    iget-object v0, v0, Lj$/util/v;->a:Lj$/util/PrimitiveIterator$OfLong;
    ...
    invoke-direct {v1, v0}, Lj$/util/u;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
