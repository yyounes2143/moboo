...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1662fromClosedRangeNkh28Cs(int i, int i2, int i3) {
    ...
    public final int m1660getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1661getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m579toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m579toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        if (i3 != Integer.MIN_VALUE) {
            this.first = i;
            this.last = UProgressionUtilKt.m1646getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
            return;
        }
