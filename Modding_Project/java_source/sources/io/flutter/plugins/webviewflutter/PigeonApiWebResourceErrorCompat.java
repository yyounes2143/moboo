...
public abstract class PigeonApiWebResourceErrorCompat {
    ...
    public PigeonApiWebResourceErrorCompat(@NotNull AndroidWebkitLibraryPigeonProxyApiRegistrar androidWebkitLibraryPigeonProxyApiRegistrar) {
    ...
    @NotNull
    public abstract String description(@NotNull WebResourceErrorCompat webResourceErrorCompat);

    public abstract long errorCode(@NotNull WebResourceErrorCompat webResourceErrorCompat);
    ...
    public final void pigeon_newInstance(@NotNull WebResourceErrorCompat webResourceErrorCompat, @NotNull final Function1<? super Result<Unit>, Unit> function1) {
