...
public final class ConscryptSocketAdapter implements SocketAdapter {
    ...
    public static final DeferredSocketAdapter.Factory f12997Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.ConscryptSocketAdapter$Companion$factory$1
        ...
        public boolean Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(@NotNull SSLSocket sSLSocket) {
            if (ConscryptPlatform.Companion.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() && Conscrypt.isConscrypt(sSLSocket)) {
                return true;
            }
            return false;
        }
    ...
    public static final class Companion {
        ...
        public final DeferredSocketAdapter.Factory Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() {
            return ConscryptSocketAdapter.f12997Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
        }
    ...
    public boolean isSupported() {
        return ConscryptPlatform.Companion.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
    }
}
