...
public final class OkHttpClient$Builder$addInterceptor$2 implements Interceptor {
    ...
    public final /* synthetic */ Function1<Interceptor.Chain, Response> f12429Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

    @Override // okhttp3.Interceptor
    @NotNull
    public final Response intercept(@NotNull Interceptor.Chain chain) {
        return this.f12429Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.invoke(chain);
    }
}
