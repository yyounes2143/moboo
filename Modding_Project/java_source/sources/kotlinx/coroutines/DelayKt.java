...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, @NotNull Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl.getContext()).mo1973scheduleResumeAfterDelay(j, cancellableContinuationImpl);
        }
    ...
    public static final Object m1902delayVtjQ1oo(long j, @NotNull Continuation<? super Unit> continuation) {
        Object delay = delay(m1903toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1903toDelayMillisLRDsOJo(long j) {
        boolean m1789isPositiveimpl = Duration.m1789isPositiveimpl(j);
        if (m1789isPositiveimpl) {
            return Duration.m1773getInWholeMillisecondsimpl(Duration.m1791plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (!m1789isPositiveimpl) {
            return 0L;
        }
