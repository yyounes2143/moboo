...
public final class UShortArrayBuilder extends PrimitiveArrayBuilder<UShortArray> {
    ...
    public final void m2019appendxj2QHRw$kotlinx_serialization_core(short s) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        short[] sArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UShortArray.m782set01HTLdE(sArr, position$kotlinx_serialization_core, s);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ UShortArray build$kotlinx_serialization_core() {
        return UShortArray.m770boximpl(m2020buildamswpOA$kotlinx_serialization_core());
    }
    ...
    public short[] m2020buildamswpOA$kotlinx_serialization_core() {
        return UShortArray.m772constructorimpl(Arrays.copyOf(this.buffer, getPosition$kotlinx_serialization_core()));
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public void ensureCapacity$kotlinx_serialization_core(int i) {
        if (UShortArray.m778getSizeimpl(this.buffer) < i) {
            short[] sArr = this.buffer;
            this.buffer = UShortArray.m772constructorimpl(Arrays.copyOf(sArr, RangesKt.coerceAtLeast(i, UShortArray.m778getSizeimpl(sArr) * 2)));
        }
    }
    ...
    private UShortArrayBuilder(short[] sArr) {
        this.buffer = sArr;
        this.position = UShortArray.m778getSizeimpl(sArr);
