...
public final class UByteArrayBuilder extends PrimitiveArrayBuilder<UByteArray> {
    ...
    public final void m1995append7apg3OU$kotlinx_serialization_core(byte b) {
        PrimitiveArrayBuilder.ensureCapacity$kotlinx_serialization_core$default(this, 0, 1, null);
        byte[] bArr = this.buffer;
        int position$kotlinx_serialization_core = getPosition$kotlinx_serialization_core();
        this.position = position$kotlinx_serialization_core + 1;
        UByteArray.m519setVurrAj0(bArr, position$kotlinx_serialization_core, b);
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public /* bridge */ /* synthetic */ UByteArray build$kotlinx_serialization_core() {
        return UByteArray.m507boximpl(m1996buildTcUX1vc$kotlinx_serialization_core());
    }
    ...
    public byte[] m1996buildTcUX1vc$kotlinx_serialization_core() {
        return UByteArray.m509constructorimpl(Arrays.copyOf(this.buffer, getPosition$kotlinx_serialization_core()));
    }

    @Override // kotlinx.serialization.internal.PrimitiveArrayBuilder
    public void ensureCapacity$kotlinx_serialization_core(int i) {
        if (UByteArray.m515getSizeimpl(this.buffer) < i) {
            byte[] bArr = this.buffer;
            this.buffer = UByteArray.m509constructorimpl(Arrays.copyOf(bArr, RangesKt.coerceAtLeast(i, UByteArray.m515getSizeimpl(bArr) * 2)));
        }
    }
    ...
    private UByteArrayBuilder(byte[] bArr) {
        this.buffer = bArr;
        this.position = UByteArray.m515getSizeimpl(bArr);
