        ...
        while (true) {
            ...
            if (trackGroups.length > 0) {
                ...
                while (i3 < trackGroups.length) {
                    ...
                    String str2 = str;
                    String adaptiveSupportString = getAdaptiveSupportString(trackGroup.length, mappedTrackInfo.getAdaptiveSupport(i2, i3, false));
                    logd("    Group:" + i3 + ", adaptive_supported=" + adaptiveSupportString + " [");
                    int i4 = 0;
                    while (i4 < trackGroup.length) {
                        String trackStatusString = getTrackStatusString(trackSelection, trackGroup, i4);
                        String formatSupportString = getFormatSupportString(mappedTrackInfo.getTrackSupport(i2, i3, i4));
