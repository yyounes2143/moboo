            ...
            if (readBits != 240) {
                switch (readBits) {
                    ...
                    case 17:
                        ...
                        i4 = paint4BitPixelCodeString(parsableBitArray, iArr3, bArr4, i4, i5, paint4, canvas2);
                        parsableBitArray.byteAlign();
                        paint = paint4;
                        iArr = iArr3;
                        canvas = canvas2;
        ...
        for (int i3 = 0; i3 < sparseArray.size(); i3++) {
            ...
            while (i6 < sparseArray2.size()) {
                ...
                if (objectData != null) {
                    ...
                    paintPixelDataSubBlocks(objectData, clutDefinition2, regionComposition.depth, i4 + valueAt2.horizontalPosition, i5 + valueAt2.verticalPosition, paint, this.canvas);
                }
                i6++;
            ...
            if (regionComposition.fillFlag) {
                ...
                if (i7 == 3) {
                    i2 = clutDefinition3.clutEntries8Bit[regionComposition.pixelCode8Bit];
                } else if (i7 == 2) {
                    i2 = clutDefinition3.clutEntries4Bit[regionComposition.pixelCode4Bit];
                } else {
                    i2 = clutDefinition3.clutEntries2Bit[regionComposition.pixelCode2Bit];
                }
