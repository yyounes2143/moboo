...
public class SplashExpandDialog extends Dialog {
    ...
    public class d implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            WindVaneWebView windVaneWebView = SplashExpandDialog.this.e;
    ...
    public SplashExpandDialog(Context context, Bundle bundle, com.mbridge.msdk.splash.middle.a aVar) {
        super(context);
        this.f9495a = "SplashExpandDialog";
        this.j = new e();
        if (bundle != null) {
    ...
    private void b() {
        ...
        BitmapDrawable a2 = com.mbridge.msdk.foundation.controller.c.m().a(this.g, 297);
        if (a2 != null) {
    ...
    public class e implements com.mbridge.msdk.mbsignalcommon.mraid.b {
        ...
        public void open(String str) {
            try {
                if (SplashExpandDialog.this.e == null || System.currentTimeMillis() - SplashExpandDialog.this.e.lastTouchTime <= com.mbridge.msdk.click.utils.a.c || !com.mbridge.msdk.click.utils.a.a((CampaignEx) SplashExpandDialog.this.h.get(0), SplashExpandDialog.this.e.getUrl(), com.mbridge.msdk.click.utils.a.f8800a)) {
        ...
        public void useCustomClose(boolean z) {
            ...
            try {
                ...
                o0.b("SplashExpandDialog", "useCustomClose", th);
            }
        }
