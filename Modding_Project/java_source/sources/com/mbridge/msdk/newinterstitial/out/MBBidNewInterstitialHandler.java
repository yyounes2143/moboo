...
public class MBBidNewInterstitialHandler implements BaseExtraInterfaceForHandler {
    ...
    public void loadFormSelfFilling() {
        a();
        if (this.f != null) {
            this.f.a(false, d.b().a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.g, true, 1));
        }
    }
    ...
    public void loadFromBid(String str) {
        a();
        if (this.f != null) {
            this.f.a(true, str, d.b().a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.g, true, 2));
        }
    }
    ...
    public void showFromBid() {
        a();
        if (this.f != null) {
            this.f.a((String) null, (String) null, (String) null, d.b().a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.g, false, -1));
        }
    }
