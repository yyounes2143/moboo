...
class k {
    ...
    public byte[] a(byte[] bArr) {
        ...
        while (i2 > 0) {
            a aVar2 = aVar.f9596a[(i << (8 - i2)) & 255];
            if (aVar2.f9596a != null || aVar2.c > i2) {
                break;
            }
    ...
    private void a(int i, int i2, byte b2) {
        ...
        while (b2 > 8) {
            b2 = (byte) (b2 - 8);
            int i3 = (i2 >>> b2) & 255;
            a[] aVarArr = aVar2.f9596a;
            if (aVarArr != null) {
                if (aVarArr[i3] == null) {
                    aVarArr[i3] = new a();
                }
                aVar2 = aVar2.f9596a[i3];
            } else {
