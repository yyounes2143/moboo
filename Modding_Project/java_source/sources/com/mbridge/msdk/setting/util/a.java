...
public class a {
    ...
    /* loaded from: classes5.dex */
    public class C0153a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            try {
                ...
                m0.a(this.f9444a.getBytes(), file);
        ...
        try {
            ...
            if (TextUtils.isEmpty(this.f9443a)) {
                ...
                if (d != null && !TextUtils.isEmpty(d.O())) {
                    a(com.mbridge.msdk.foundation.controller.c.m().d(), d.O());
                }
                return b;
            }
            return this.f9443a;
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(a2) || !a2.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0153a(str), "mraid_js", 60000L);
            } catch (Exception e) {
