...
public class BannerExpandDialog extends Dialog {
    ...
    public class d implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            WindVaneWebView windVaneWebView = BannerExpandDialog.this.e;
    ...
    public BannerExpandDialog(Context context, Bundle bundle, com.mbridge.msdk.mbbanner.common.listener.a aVar) {
        super(context);
        this.f9170a = "BannerExpandDialog";
        this.j = new e();
        if (bundle != null) {
    ...
    public class e implements com.mbridge.msdk.mbsignalcommon.mraid.b {
        ...
        public void open(String str) {
            try {
                if (BannerExpandDialog.this.e == null || System.currentTimeMillis() - BannerExpandDialog.this.e.lastTouchTime <= com.mbridge.msdk.click.utils.a.c || !com.mbridge.msdk.click.utils.a.a((CampaignEx) BannerExpandDialog.this.h.get(0), BannerExpandDialog.this.e.getUrl(), com.mbridge.msdk.click.utils.a.f8800a)) {
        ...
        public void useCustomClose(boolean z) {
            int i;
            try {
                TextView textView = BannerExpandDialog.this.f;
                if (z) {
                    i = 4;
                } else {
                    i = 0;
                ...
                o0.b("BannerExpandDialog", "useCustomClose", th);
            }
        }
