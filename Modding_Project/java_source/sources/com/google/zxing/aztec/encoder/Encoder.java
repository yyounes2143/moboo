...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            ...
            int i16 = 0;
            while (i15 <= 32) {
                boolean z2 = i15 <= i10 ? i13 : i12;
                int i17 = z2 ? i15 + 1 : i15;
                int i18 = totalBitsInLayer(i17, z2);
                if (size2 <= i18) {
                    ...
                    int i20 = i18 - (i18 % i16);
                    i3 = i10;
                    if ((!z2 || bitArray2.getSize() <= (i16 << 6)) && bitArray2.getSize() + size <= i20) {
                        bitArray = bitArray2;
                        i4 = i16;
                        z = z2;
                        i5 = i17;
        ...
        int i21 = (z ? 11 : 14) + (i5 << 2);
        int[] iArr = new int[i21];
        if (z) {
            for (int i22 = i12; i22 < i21; i22 += i13) {
                iArr[i22] = i22;
            }
            i7 = i21;
        } else {
            int i23 = i21 / 2;
            i7 = i21 + 1 + (((i23 - 1) / 15) * i11);
            int i24 = i7 / 2;
            for (int i25 = i12; i25 < i23; i25 += i13) {
                iArr[(i23 - i25) - i13] = (i24 - i8) - 1;
        ...
        int i27 = i26;
        while (i26 < i5) {
            int i28 = ((i5 - i26) << i11) + (z ? 9 : 12);
            int i29 = i12;
            while (i29 < i28) {
                int i30 = i29 << 1;
                while (i12 < i11) {
                    int i31 = i11;
                    if (generateCheckWords.get(i27 + i30 + i12)) {
                        int i32 = i26 << 1;
                        i9 = i13;
                        bitMatrix.set(iArr[i32 + i12], iArr[i32 + i29]);
                    } else {
                        i9 = i13;
                    }
                    if (generateCheckWords.get((i28 << 1) + i27 + i30 + i12)) {
                        int i33 = i26 << 1;
                        bitMatrix.set(iArr[i33 + i29], iArr[((i21 - 1) - i33) - i12]);
                    }
                    if (generateCheckWords.get((i28 << 2) + i27 + i30 + i12)) {
                        int i34 = (i21 - 1) - (i26 << 1);
                        bitMatrix.set(iArr[i34 - i12], iArr[i34 - i29]);
                    }
                    if (generateCheckWords.get((i28 * 6) + i27 + i30 + i12)) {
                        int i35 = i26 << 1;
                        bitMatrix.set(iArr[((i21 - 1) - i35) - i29], iArr[i35 + i12]);
                    }
                    i12++;
                    i11 = i31;
                    i13 = i9;
