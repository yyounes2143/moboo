...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) throws NotFoundException {
        ...
        this.compact = z;
        ResultPoint resultPoint = new ResultPoint(point2.getX() + 0.5f, point2.getY() - 0.5f);
        ResultPoint resultPoint2 = new ResultPoint(point3.getX() + 0.5f, point3.getY() + 0.5f);
        ResultPoint resultPoint3 = new ResultPoint(point4.getX() - 0.5f, point4.getY() + 0.5f);
        ResultPoint resultPoint4 = new ResultPoint(point5.getX() - 0.5f, point5.getY() - 0.5f);
        ResultPoint[] resultPointArr = new ResultPoint[4];
        resultPointArr[0] = resultPoint;
        resultPointArr[1] = resultPoint2;
        resultPointArr[2] = resultPoint3;
        resultPointArr[c] = resultPoint4;
        return expandSquare(resultPointArr, (i * 2) - 3, this.nbCenterLayers * 2);
    }
