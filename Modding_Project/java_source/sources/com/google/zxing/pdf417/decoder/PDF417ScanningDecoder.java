    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        while (i5 < 2) {
            if (resultPoint != null) {
                ...
                detectionResultRowIndicatorColumn2 = detectionResultRowIndicatorColumn3;
            }
            if (resultPoint3 != null) {
                detectionResultRowIndicatorColumn4 = getRowIndicatorColumn(bitMatrix, boundingBox2, resultPoint3, false, i, i2);
            }
            boundingBox = boundingBox2;
            detectionResult = merge(detectionResultRowIndicatorColumn2, detectionResultRowIndicatorColumn4);
            if (detectionResult != null) {
                if (i5 == 0 && detectionResult.getBoundingBox() != null && (detectionResult.getBoundingBox().getMinY() < boundingBox.getMinY() || detectionResult.getBoundingBox().getMaxY() > boundingBox.getMaxY())) {
                    ...
                    i5++;
                    detectionResultRowIndicatorColumn3 = detectionResultRowIndicatorColumn2;
                } else {
        ...
        if (detectionResultRowIndicatorColumn3 != null) {
            z = true;
        } else {
            z = false;
        }
        ...
        while (i8 <= barcodeColumnCount) {
            if (z) {
                ...
                i3 = barcodeColumnCount - i8;
            }
            if (detectionResult2.getDetectionResultColumn(i3) == null) {
                ...
                detectionResult2.setDetectionResultColumn(i3, detectionResultRowIndicatorColumn);
                int i9 = -1;
                int i10 = i6;
                int i11 = i7;
                ...
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResult2, i3, minY, z);
                    ...
                    i4 = i9;
                    int i13 = startColumn;
                    Codeword detectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z, i13, minY, i10, i11);
