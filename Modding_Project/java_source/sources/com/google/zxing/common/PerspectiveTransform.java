...
public final class PerspectiveTransform {
    ...
    public PerspectiveTransform times(PerspectiveTransform perspectiveTransform) {
        ...
        float f23 = this.a33;
        return new PerspectiveTransform(f7, f11, (f * f12) + (f3 * f13) + (f5 * f14), (f15 * f2) + (f16 * f4) + (f17 * f6), (f15 * f8) + (f16 * f9) + (f17 * f10), f18, f22 + (f6 * f23), (f19 * f8) + (f9 * f21) + (f10 * f23), (f19 * f12) + (f21 * f13) + (f23 * f14));
    }
