...
public class DataTransportCrashlyticsReportSender {
    ...
    private static final Transformer<CrashlyticsReport, byte[]> DEFAULT_TRANSFORM = new Transformer() { // from class: com.google.firebase.crashlytics.internal.send.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
