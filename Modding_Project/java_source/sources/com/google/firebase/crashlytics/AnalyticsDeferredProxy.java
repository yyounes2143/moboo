...
public class AnalyticsDeferredProxy {
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(AnalyticsDeferredProxy analyticsDeferredProxy, BreadcrumbHandler breadcrumbHandler) {
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(AnalyticsDeferredProxy analyticsDeferredProxy, Provider provider) {
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            ...
            synchronized (analyticsDeferredProxy) {
                try {
                    for (BreadcrumbHandler breadcrumbHandler : analyticsDeferredProxy.breadcrumbHandlerList) {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // com.google.firebase.inject.Deferred.DeferredHandler
            public final void handle(Provider provider) {
                AnalyticsDeferredProxy.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(AnalyticsDeferredProxy.this, provider);
            }
        });
    }
    ...
    public AnalyticsEventLogger getAnalyticsEventLogger() {
        return new AnalyticsEventLogger() { // from class: com.google.firebase.crashlytics.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: com.google.firebase.crashlytics.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // com.google.firebase.crashlytics.internal.breadcrumbs.BreadcrumbSource
            public final void registerBreadcrumbHandler(BreadcrumbHandler breadcrumbHandler) {
                AnalyticsDeferredProxy.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(AnalyticsDeferredProxy.this, breadcrumbHandler);
            }
        };
    }
