...
public final class CctTransportBackend implements TransportBackend {
    ...
    public static final class HttpRequest {
        ...
        public HttpRequest(URL url, BatchedLogRequest batchedLogRequest, @Nullable String str, @Nullable String str2) {
            this.url = url;
    ...
    public static /* synthetic */ HttpRequest Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(HttpRequest httpRequest, HttpResponse httpResponse) {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        String str = httpRequest.pseudonymousId;
        if (str != null) {
            httpURLConnection.setRequestProperty("Cookie", String.format("NID=%s", str));
        }
        String str2 = httpRequest.apiKey;
        if (str2 != null) {
            httpURLConnection.setRequestProperty(API_KEY_HEADER_KEY, str2);
        }
        try {
    ...
    private String findPseudonymousId(BackendRequest backendRequest) {
        ...
        for (EventInternal eventInternal : backendRequest.getEvents()) {
            String pseudonymousId2 = eventInternal.getPseudonymousId();
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, str, findPseudonymousId(backendRequest)), new Function() { // from class: com.google.android.datatransport.cct.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            ...
            }, new RetryStrategy() { // from class: com.google.android.datatransport.cct.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
                @Override // com.google.android.datatransport.runtime.retries.RetryStrategy
                public final Object shouldRetry(Object obj, Object obj2) {
                    return CctTransportBackend.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww((CctTransportBackend.HttpRequest) obj, (CctTransportBackend.HttpResponse) obj2);
                }
            });
