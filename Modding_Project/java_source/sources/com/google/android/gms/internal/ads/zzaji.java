...
public final class zzaji {
    ...
    */
    public zzaji(boolean r5, @androidx.annotation.Nullable java.lang.String r6, int r7, byte[] r8, int r9, int r10, @androidx.annotation.Nullable byte[] r11) {
        /*
            r4 = this;
            r4.<init>()
            r0 = 0
        ...
        L77:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaji.<init>(boolean, java.lang.String, int, byte[], int, int, byte[]):void");
    }
}
