...
public final class zzgzs extends zzgww implements RandomAccess, zzgzd, zzham {
    ...
    private static final zzgzs zzb;
    private long[] zzc;
    private int zzd;
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgzsVar.zzc, 0, this.zzc, this.zzd, zzgzsVar.zzd);
            this.zzd = i3;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzd != zzgzsVar.zzd) {
            return false;
        }
        long[] jArr = zzgzsVar.zzc;
    ...
    public final zzgzd zzf(int i) {
        ...
        if (i >= this.zzd) {
            ...
            return new zzgzs(copyOf, this.zzd, true);
        }
    ...
    private zzgzs(long[] jArr, int i, boolean z) {
        super(z);
        this.zzc = jArr;
        this.zzd = i;
    }
