...
public final class zzfuf {
    private static final zzfud zza = new zzfud("PhoneskyVerificationUtils");
                ...
                try {
                    ...
                    if (signatureArr != null && (r2 = signatureArr.length) != 0) {
                        ...
                        for (Signature signature : signatureArr) {
                            String zza2 = zzfue.zza(signature.toByteArray());
                            arrayList.add(zza2);
                        ...
                        zzfudVar.zzd(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", sb.toString()), new Object[0]);
                    } else {
