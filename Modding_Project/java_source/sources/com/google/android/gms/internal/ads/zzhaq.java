...
interface zzhaq {
    ...
    @Deprecated
    void zzC(List list, zzhaw zzhawVar, zzgyc zzgycVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhaw zzhawVar, zzgyc zzgycVar) throws IOException;
    ...
    zzgxk zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzhaw zzhawVar, zzgyc zzgycVar) throws IOException;

    void zzu(Object obj, zzhaw zzhawVar, zzgyc zzgycVar) throws IOException;
