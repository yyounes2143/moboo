...
public final class Asserts {
    ...
    public static void checkMainThread(@NonNull String str) {
        ...
        new StringBuilder(String.valueOf(Thread.currentThread()).length() + 56 + String.valueOf(Looper.getMainLooper().getThread()).length() + 1);
    ...
    public static void checkNotMainThread(@NonNull String str) {
        ...
        new StringBuilder(String.valueOf(Thread.currentThread()).length() + 55 + String.valueOf(Looper.getMainLooper().getThread()).length() + 1);
        throw new IllegalStateException(str);
    }
