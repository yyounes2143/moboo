...
public class HctSolver {
    ...
    */
    public static double[][] bisectToSegment(double r20, double r22) {
        /*
            r0 = 3
    ...
    public static int findResultByJ(double d, double d2, double d3) {
        ...
        while (i < 5) {
            ...
            if (d2 != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE && sqrt != FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                d4 = d2 / Math.sqrt(d9);
            } else {
                d4 = 0.0d;
            }
            ...
            double d11 = d4 * pow;
            double d12 = d7;
            double pow2 = Math.pow(d11, 1.1111111111111112d);
            double d13 = sqrt;
            double aw = (viewingConditions.getAw() * Math.pow(d9, (d10 / viewingConditions.getC()) / viewingConditions.getZ())) / viewingConditions.getNbb();
            double d14 = (((0.305d + aw) * 23.0d) * pow2) / (((23.0d * cos) + ((pow2 * d8) * cos2)) + ((pow2 * 108.0d) * sin));
            double d15 = d14 * cos2;
            double d16 = d14 * sin;
