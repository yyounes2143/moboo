...
public final class FoodReorderCluster extends com.google.android.engage.common.datamodel.zzf {
    ...
    public static final class Builder {
        ...
        public FoodReorderCluster build() {
            return new FoodReorderCluster(this, null);
        }
    ...
    public /* synthetic */ FoodReorderCluster(Builder builder, zzd zzdVar) {
        super(5);
