...
public interface IAppEngageServicePublishClustersCallback extends IInterface {
    ...
    public static abstract class Stub extends zzb implements IAppEngageServicePublishClustersCallback {
        ...
        public static IAppEngageServicePublishClustersCallback asInterface(@NonNull IBinder iBinder) {
            ...
            if (queryLocalInterface instanceof IAppEngageServicePublishClustersCallback) {
                return (IAppEngageServicePublishClustersCallback) queryLocalInterface;
            }
        ...
        public boolean dispatchTransaction(int i, @NonNull Parcel parcel, @NonNull Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                zzc.zzb(parcel);
                onPublishClusters((Bundle) zzc.zza(parcel, Bundle.CREATOR));
                return true;
            }
            return false;
        }
