...
public interface IAppEngageServiceDeleteClustersCallback extends IInterface {

    /* compiled from: Proguard */
    /* loaded from: classes4.dex */
    public static abstract class Stub extends zzb implements IAppEngageServiceDeleteClustersCallback {

        /* compiled from: Proguard */
        /* loaded from: classes4.dex */
        public static class Proxy extends zza implements IAppEngageServiceDeleteClustersCallback {
        ...
        @NonNull
        public static IAppEngageServiceDeleteClustersCallback asInterface(@NonNull IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            if (queryLocalInterface instanceof IAppEngageServiceDeleteClustersCallback) {
                return (IAppEngageServiceDeleteClustersCallback) queryLocalInterface;
            }
        ...
        public boolean dispatchTransaction(int i, @NonNull Parcel parcel, @NonNull Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                zzc.zzb(parcel);
                onDeleteClusters((Bundle) zzc.zza(parcel, Bundle.CREATOR));
                return true;
            }
            return false;
        }
