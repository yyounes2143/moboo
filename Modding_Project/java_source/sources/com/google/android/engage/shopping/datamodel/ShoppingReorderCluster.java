...
public final class ShoppingReorderCluster extends zzf {
    ...
    public static final class Builder {
        ...
        public ShoppingReorderCluster build() {
            return new ShoppingReorderCluster(this, null);
        }
    ...
    public /* synthetic */ ShoppingReorderCluster(Builder builder, zze zzeVar) {
        super(10);
