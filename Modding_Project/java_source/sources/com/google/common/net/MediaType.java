...
public final class MediaType {
    ...
    public static /* synthetic */ String Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(String str) {
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, new Function() { // from class: com.google.common.net.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return MediaType.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww((String) obj);
                }
            }).entries());
        }
        return sb.toString();
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new Function() { // from class: com.google.common.net.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
    ...
    public boolean is(MediaType mediaType) {
        if (mediaType.type.equals("*") || mediaType.type.equals(this.type)) {
            if ((mediaType.subtype.equals("*") || mediaType.subtype.equals(this.subtype)) && this.parameters.entries().containsAll(mediaType.parameters.entries())) {
                return true;
            }
            return false;
        }
