...
public abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
    ...
    public static /* synthetic */ int Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Comparator comparator, Comparator comparator2, Table.Cell cell, Table.Cell cell2) {
        int compare;
        if (comparator == null) {
            compare = 0;
        } else {
    ...
    public static <R, C, V> RegularImmutableTable<R, C, V> forCells(List<Table.Cell<R, C, V>> list, @CheckForNull final Comparator<? super R> comparator, @CheckForNull final Comparator<? super C> comparator2) {
        ...
        if (comparator != null || comparator2 != null) {
            Collections.sort(list, new Comparator() { // from class: com.google.common.collect.O00
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return RegularImmutableTable.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(comparator, comparator2, (Table.Cell) obj, (Table.Cell) obj2);
                }
            });
        }
