...
abstract class WrappingExecutorService implements ExecutorService {
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Callable callable) {
        try {
            callable.call();
        } catch (Exception e) {
    ...
    public Runnable wrapTask(Runnable runnable) {
        ...
        return new Runnable() { // from class: com.google.common.util.concurrent.Kkkkkkkkkkkkkkkkkkkkkkkk
            @Override // java.lang.Runnable
            public final void run() {
                WrappingExecutorService.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(wrapTask);
            }
        };
    }
