...
public final class ExecutionSequencer {
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(TrustedListenableFutureTask trustedListenableFutureTask, SettableFuture settableFuture, ListenableFuture listenableFuture, ListenableFuture listenableFuture2, TaskNonReentrantExecutor taskNonReentrantExecutor) {
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> asyncCallable, Executor executor) {
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.Wwwwwwwwwwwwwwwww
            @Override // java.lang.Runnable
            public final void run() {
                ExecutionSequencer.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(TrustedListenableFutureTask.this, create, andSet, nonCancellationPropagating, taskNonReentrantExecutor);
            }
        };
