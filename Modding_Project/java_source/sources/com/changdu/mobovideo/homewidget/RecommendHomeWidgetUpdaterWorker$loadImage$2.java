...
@DebugMetadata(c = "com.changdu.mobovideo.homewidget.RecommendHomeWidgetUpdaterWorker$loadImage$2", f = "RecommendHomeWidgetProvider.kt", i = {}, l = {232}, m = "invokeSuspend", n = {}, s = {})
...
public final class RecommendHomeWidgetUpdaterWorker$loadImage$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Bitmap>, Object> {
    final /* synthetic */ String $imageUrl;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RecommendHomeWidgetUpdaterWorker$loadImage$2(String str, Continuation<? super RecommendHomeWidgetUpdaterWorker$loadImage$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new RecommendHomeWidgetUpdaterWorker$loadImage$2(this.$imageUrl, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Bitmap> continuation) {
        return ((RecommendHomeWidgetUpdaterWorker$loadImage$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
