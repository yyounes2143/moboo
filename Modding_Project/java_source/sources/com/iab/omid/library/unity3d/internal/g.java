...
public class g {
    ...
    public static g f8453Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = new g();

    /* loaded from: classes5.dex */
    public class a implements Runnable {

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final /* synthetic */ String f8455Wwwwwwwwwwwwwwwwwwwwwwww;

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final /* synthetic */ WebView f8456Wwwwwwwwwwwwwwwwwwwwwwwww;

        public a(WebView webView, String str) {
            this.f8456Wwwwwwwwwwwwwwwwwwwwwwwww = webView;
            this.f8455Wwwwwwwwwwwwwwwwwwwwwwww = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            g.this.Wwwwwwwwwwwwwwwwwwww(this.f8456Wwwwwwwwwwwwwwwwwwwwwwwww, this.f8455Wwwwwwwwwwwwwwwwwwwwwwww);
        }
    }

    public static final g Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() {
        return f8453Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
    }
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwwwwww(WebView webView, String str, Object... objArr) {
        ...
        com.iab.omid.library.unity3d.utils.d.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww("The WebView is null for " + str);
    }
