...
public class c {
    ...
    public static WindowManager f8484Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public static String[] f8483Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = {"x", "y", "width", "height"};

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public static float f8482Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = Resources.getSystem().getDisplayMetrics().density;

    /* loaded from: classes5.dex */
    public static /* synthetic */ class a {

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public static final /* synthetic */ int[] f8485Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        static {
            int[] iArr = new int[OutputDeviceStatus.values().length];
            f8485Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = iArr;
            try {
    ...
    public static class b {
        ...
        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final float f8486Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final float f8487Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        public b(float f, float f2) {
            this.f8487Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = f;
            this.f8486Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = f2;
        }
    }

    public static boolean Wwwwwwwwwwwwww(@NonNull JSONObject jSONObject, @Nullable JSONObject jSONObject2) {
        if (jSONObject == null && jSONObject2 == null) {
            return true;
        }
        if (jSONObject != null && jSONObject2 != null && Wwwwwwwwwwwwwwww(jSONObject, jSONObject2) && Wwwwwwwwwwwwwww(jSONObject, jSONObject2) && Wwwwwwwwwwwwwwwww(jSONObject, jSONObject2) && Wwwwwwwwwwwwwwwwww(jSONObject, jSONObject2) && Wwwwwwwwwwwwwwwwwww(jSONObject, jSONObject2) && Wwwwwwwwwwwwwwwwwwww(jSONObject, jSONObject2)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean Wwwwwwwwwwwwwwww(JSONObject jSONObject, JSONObject jSONObject2) {
        String[] strArr;
        for (String str : f8483Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww) {
    ...
    public static boolean Wwwwwwwwwwwwwwwwwwww(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            if (!Wwwwwwwwwwwwww(optJSONArray.optJSONObject(i), optJSONArray2.optJSONObject(i))) {
                return false;
            }
        }
        return true;
    ...
    public static void Wwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject, String str) {
        try {
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.f8487Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww);
            jSONObject.put("height", Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.f8486Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    ...
    public static boolean Wwwwwwwwwwwwwwwwwwwwwwww(OutputDeviceStatus outputDeviceStatus) {
        if (a.f8485Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww[outputDeviceStatus.ordinal()] == 1) {
            return true;
        }
        return false;
    }
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject, a.C0076a c0076a) {
        com.iab.omid.library.unity3d.internal.e Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = c0076a.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = c0076a.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Context context) {
        if (context != null) {
            f8482Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = context.getResources().getDisplayMetrics().density;
            f8484Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static b Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject) {
        float f;
        float f2;
        if (f8484Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww != null) {
            Point point = new Point(0, 0);
            f8484Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.getDefaultDisplay().getRealSize(point);
    ...
    public static float Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(int i) {
        return i / f8482Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
    }
}
