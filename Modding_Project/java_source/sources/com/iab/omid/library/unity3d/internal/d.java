...
public class d implements Application.ActivityLifecycleCallbacks {
    ...
    public a f8444Wwwwwwwwwwwwwwwwwwwwwww;

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public boolean f8445Wwwwwwwwwwwwwwwwwwwwwwww;

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public boolean f8446Wwwwwwwwwwwwwwwwwwwwwwwww;
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwww() {
        this.f8446Wwwwwwwwwwwwwwwwwwwwwwwww = false;
        this.f8444Wwwwwwwwwwwwwwwwwwwwwww = null;
    }

    public void Wwwwwwwwwwwwwwwwwwwwwwwwww() {
        this.f8446Wwwwwwwwwwwwwwwwwwwwwwwww = true;
        boolean Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
        this.f8445Wwwwwwwwwwwwwwwwwwwwwwww = Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2;
    ...
    public boolean Wwwwwwwwwwwwwwwwwwwwwwwwwwww() {
        return this.f8445Wwwwwwwwwwwwwwwwwwwwwwww;
    }
    ...
    public final void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(boolean z) {
        if (this.f8445Wwwwwwwwwwwwwwwwwwwwwwww != z) {
            this.f8445Wwwwwwwwwwwwwwwwwwwwwwww = z;
            if (this.f8446Wwwwwwwwwwwwwwwwwwwwwwwww) {
                Wwwwwwwwwwwwwwwwwwwwwwwwwwwww(z);
                a aVar = this.f8444Wwwwwwwwwwwwwwwwwwwwwww;
                if (aVar != null) {
                    aVar.a(z);
                }
            }
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(a aVar) {
        this.f8444Wwwwwwwwwwwwwwwwwwwwwww = aVar;
    }
