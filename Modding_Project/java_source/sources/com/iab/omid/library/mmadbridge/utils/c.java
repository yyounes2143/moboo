...
public class c {
    ...
    public static WindowManager f8345Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public static String[] f8344Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = {"x", "y", "width", "height"};

    /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
    public static float f8343Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = Resources.getSystem().getDisplayMetrics().density;

    /* loaded from: classes5.dex */
    public static /* synthetic */ class a {

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public static final /* synthetic */ int[] f8346Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        static {
            int[] iArr = new int[OutputDeviceStatus.values().length];
            f8346Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = iArr;
            try {
    ...
    public static class b {
        ...
        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final float f8347Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        /* renamed from: Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  reason: collision with root package name */
        public final float f8348Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;

        public b(float f, float f2) {
            this.f8348Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = f;
            this.f8347Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = f2;
        }
    }
    ...
    public static boolean Wwwwwwwwwwwwwww(JSONObject jSONObject, JSONObject jSONObject2) {
        String[] strArr;
        for (String str : f8344Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww) {
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.f8348Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww);
            jSONObject.put("height", Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.f8347Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww);
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    ...
    public static boolean Wwwwwwwwwwwwwwwwwwwwwwww(OutputDeviceStatus outputDeviceStatus) {
        if (a.f8346Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww[outputDeviceStatus.ordinal()] == 1) {
            return true;
        }
        return false;
    }
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject, a.C0072a c0072a) {
        com.iab.omid.library.mmadbridge.internal.e Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = c0072a.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = c0072a.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
    ...
    public static void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Context context) {
        if (context != null) {
            f8343Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = context.getResources().getDisplayMetrics().density;
            f8345Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static b Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(JSONObject jSONObject) {
        float f;
        float f2;
        if (f8345Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww != null) {
            Point point = new Point(0, 0);
            f8345Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.getDefaultDisplay().getRealSize(point);
    ...
    public static float Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(int i) {
        return i / f8343Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
    }
}
