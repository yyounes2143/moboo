...
public class e {
    ...
    public static OutputDeviceStatus f8349Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = OutputDeviceStatus.UNKNOWN;
    ...
    public class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction() == "android.media.action.HDMI_AUDIO_PLUG") {
                ...
                OutputDeviceStatus unused = e.f8349Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww = outputDeviceStatus;
            }
        }
    }
    ...
    public static OutputDeviceStatus Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() {
        if (com.iab.omid.library.mmadbridge.utils.a.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww() != DeviceCategory.CTV) {
            return OutputDeviceStatus.UNKNOWN;
        }
        return f8349Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
    }
}
