...
public final class AndroidEmbeddableWebViewAdPlayer$destroy$1 extends ContinuationImpl {
    ...
    public AndroidEmbeddableWebViewAdPlayer$destroy$1(AndroidEmbeddableWebViewAdPlayer androidEmbeddableWebViewAdPlayer, Continuation<? super AndroidEmbeddableWebViewAdPlayer$destroy$1> continuation) {
        super(continuation);
