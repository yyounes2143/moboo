...
public final class AndroidFullscreenWebViewAdPlayer$destroy$1 extends ContinuationImpl {
    ...
    public AndroidFullscreenWebViewAdPlayer$destroy$1(AndroidFullscreenWebViewAdPlayer androidFullscreenWebViewAdPlayer, Continuation<? super AndroidFullscreenWebViewAdPlayer$destroy$1> continuation) {
        super(continuation);
