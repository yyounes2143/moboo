...
public final class DeveloperConsentFlattenerRulesUseCase implements FlattenerRulesUseCase {
    ...
    public JsonFlattenerRules invoke() {
        return new JsonFlattenerRules(CollectionsKt.mutableListOf("privacy", "gdpr", "pipl", "user"), CollectionsKt.listOf("value"), CollectionsKt.mutableListOf(CampaignEx.JSON_KEY_ST_TS));
    }
}
