...
public class ScarAdapter extends ScarAdapterBase implements IScarAdapter {
    ...
    public AdRequestFactory f10930Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww;
    ...
    public ScarAdapter(IAdsErrorHandler<WebViewAdsError> iAdsErrorHandler, String str) {
        ...
        this.f10930Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww = adRequestFactory;
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwwwwww(Context context, final ScarAdMetadata scarAdMetadata, IScarInterstitialAdListenerWrapper iScarInterstitialAdListenerWrapper) {
        final ScarInterstitialAd scarInterstitialAd = new ScarInterstitialAd(context, this.f10930Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww, scarAdMetadata, this.f10860Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, iScarInterstitialAdListenerWrapper);
        Utils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new Runnable() { // from class: com.unity3d.scar.adapter.v2300.ScarAdapter.1
            @Override // java.lang.Runnable
            public void run() {
                scarInterstitialAd.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new IScarLoadListener() { // from class: com.unity3d.scar.adapter.v2300.ScarAdapter.1.1
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwwwwwww(Context context, final ScarAdMetadata scarAdMetadata, IScarRewardedAdListenerWrapper iScarRewardedAdListenerWrapper) {
        final ScarRewardedAd scarRewardedAd = new ScarRewardedAd(context, this.f10930Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww, scarAdMetadata, this.f10860Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, iScarRewardedAdListenerWrapper);
        Utils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new Runnable() { // from class: com.unity3d.scar.adapter.v2300.ScarAdapter.2
            @Override // java.lang.Runnable
            public void run() {
                scarRewardedAd.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new IScarLoadListener() { // from class: com.unity3d.scar.adapter.v2300.ScarAdapter.2.1
                    @Override // com.unity3d.scar.adapter.common.scarads.IScarLoadListener
                    public void onAdLoaded() {
    ...
    public void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Context context, RelativeLayout relativeLayout, ScarAdMetadata scarAdMetadata, int i, int i2, IScarBannerAdListenerWrapper iScarBannerAdListenerWrapper) {
        final ScarBannerAd scarBannerAd = new ScarBannerAd(context, relativeLayout, this.f10930Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww, scarAdMetadata, i, i2, this.f10860Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww, iScarBannerAdListenerWrapper);
        Utils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(new Runnable() { // from class: com.unity3d.scar.adapter.v2300.ScarAdapter.3
            @Override // java.lang.Runnable
            public void run() {
