...
public final class C1034Ur implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (AbstractC1077Wl.A02 * 4.0f);
    public static final int A07 = (int) (AbstractC1077Wl.A02 * 1.0f);
    ...
    public final int A04(float f) {
        ...
        return OP.A05((this.A01 & ViewCompat.MEASURED_STATE_MASK) | ((~this.A01) & ViewCompat.MEASURED_SIZE_MASK), textColor, f);
    }
