...
public final class AdPayload$TemplateSettings$$serializer implements GeneratedSerializer<AdPayload.TemplateSettings> {
    ...
    public AdPayload.TemplateSettings deserialize(@NotNull Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            ...
            obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 1, new LinkedHashMapSerializer(stringSerializer, AdPayload$CacheableReplacement$$serializer.INSTANCE), null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
