...
public final class AdPayload$WebViewSettings$$serializer implements GeneratedSerializer<AdPayload.WebViewSettings> {
    ...
    public AdPayload.WebViewSettings deserialize(@NotNull Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            BooleanSerializer booleanSerializer = BooleanSerializer.INSTANCE;
            obj2 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, booleanSerializer, null);
            obj = beginStructure.decodeNullableSerializableElement(descriptor2, 1, booleanSerializer, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj3 = beginStructure.decodeNullableSerializableElement(descriptor2, 0, BooleanSerializer.INSTANCE, obj3);
                    i2 |= 1;
                } else if (decodeElementIndex != 1) {
                    throw new UnknownFieldException(decodeElementIndex);
                } else {
                    obj = beginStructure.decodeNullableSerializableElement(descriptor2, 1, BooleanSerializer.INSTANCE, obj);
                    i2 |= 2;
                }
            }
            i = i2;
        ...
        return new AdPayload.WebViewSettings(i, (Boolean) obj2, (Boolean) obj, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull AdPayload.WebViewSettings webViewSettings) {
        ...
        AdPayload.WebViewSettings.write$Self(webViewSettings, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
