...
public final class FirstPartyData$$serializer implements GeneratedSerializer<FirstPartyData> {
    ...
    public FirstPartyData deserialize(@NotNull Decoder decoder) {
        ...
        if (beginStructure.decodeSequentially()) {
            ...
            StringSerializer stringSerializer = StringSerializer.INSTANCE;
            obj5 = beginStructure.decodeNullableSerializableElement(descriptor2, 4, new LinkedHashMapSerializer(stringSerializer, stringSerializer), null);
            i = 31;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    obj10 = beginStructure.decodeNullableSerializableElement(descriptor2, 4, new LinkedHashMapSerializer(stringSerializer2, stringSerializer2), obj10);
                    i2 |= 16;
                }
            }
            Object obj11 = obj6;
