...
final class SupportSQLitePooledConnection implements Transactor, RawConnectionAccessor {
    ...
    public SupportSQLitePooledConnection(@NotNull SupportSQLiteConnection supportSQLiteConnection) {
    ...
    /* JADX WARN: Type inference failed for: r6v0, types: [java.lang.Enum, androidx.room.Transactor$SQLiteTransactionType] */
