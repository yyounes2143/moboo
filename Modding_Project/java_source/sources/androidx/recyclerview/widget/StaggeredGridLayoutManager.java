...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i4 = i;
        staggeredGridLayoutManager.updateAllRemainingSpans(layoutState.mLayoutDirection, i4);
        ...
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager.mLayoutState.mInfinite || !staggeredGridLayoutManager.mRemainingSpans.isEmpty())) {
            ...
            if (z) {
                if (layoutParams.mFullSpan) {
                    ...
                    span = staggeredGridLayoutManager.getNextSpan(layoutState);
                }
            ...
            if (layoutState.mLayoutDirection == 1) {
                if (layoutParams.mFullSpan) {
                    decoratedMeasurement = staggeredGridLayoutManager.getMaxEnd(i5);
                } else {
                    decoratedMeasurement = span3.getEndLine(i5);
                }
                i2 = staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                ...
                if (layoutParams.mFullSpan) {
                    startLine = staggeredGridLayoutManager.getMinStart(i5);
                } else {
                    startLine = span3.getStartLine(i5);
                }
                i2 = startLine;
                decoratedMeasurement = i2 - staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (z && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem createFullSpanItemFromStart = staggeredGridLayoutManager.createFullSpanItemFromStart(i2);
            ...
            if (staggeredGridLayoutManager.isLayoutRTL() && staggeredGridLayoutManager.mOrientation == 1) {
                if (layoutParams.mFullSpan) {
                    decoratedMeasurement2 = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding();
                } else {
                    decoratedMeasurement2 = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding() - (((staggeredGridLayoutManager.mSpanCount - 1) - span3.mIndex) * staggeredGridLayoutManager.mSizePerSpan);
                }
                i3 = decoratedMeasurement2 - staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                if (layoutParams.mFullSpan) {
                ...
                decoratedMeasurement2 = staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(next) + i3;
            }
            int i6 = decoratedMeasurement2;
            int i7 = i3;
            if (staggeredGridLayoutManager.mOrientation == 1) {
                staggeredGridLayoutManager.layoutDecoratedWithMargins(next, i7, decoratedMeasurement, i6, i2);
                staggeredGridLayoutManager = this;
            } else {
                staggeredGridLayoutManager.layoutDecoratedWithMargins(next, decoratedMeasurement, i7, i2, i6);
            }
            if (layoutParams.mFullSpan) {
