...
public class ShortcutInfoCompat {
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo shortcutInfo : list) {
            arrayList.add(new Builder(context, Wwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(shortcutInfo)).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        shortLabel = Wwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.mContext, this.mId).setShortLabel(this.mLabel);
