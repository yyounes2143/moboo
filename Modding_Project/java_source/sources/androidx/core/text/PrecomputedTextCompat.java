...
public class PrecomputedTextCompat implements Spannable {
    ...
    public PrecomputedText getPrecomputedText() {
        if (Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.mText)) {
            return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.mText);
        }
        return null;
    }
    ...
    public static final class Params {
        ...
        public Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = Wwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(textPaint).setBreakStrategy(i);
