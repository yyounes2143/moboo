...
public final class BuildCompat {
    ...
    public static final boolean isAtLeastB() {
        ...
        if (i < 36) {
            if (i < 35 || !isAtLeastPreReleaseCodename("Baklava", Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
    ...
    private static final Integer isAtLeastPreReleaseCodename$codenameToInt(String str) {
        if (Intrinsics.areEqual(str.toUpperCase(Locale.ROOT), "BAKLAVA")) {
            return 0;
        }
        return null;
    }
    ...
    public static final boolean isAtLeastS() {
        int i = Build.VERSION.SDK_INT;
        if (i < 31) {
            if (i < 30 || !isAtLeastPreReleaseCodename(ExifInterface.LATITUDE_SOUTH, Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
    ...
    public static final boolean isAtLeastSv2() {
        int i = Build.VERSION.SDK_INT;
        if (i < 32) {
            if (i < 31 || !isAtLeastPreReleaseCodename("Sv2", Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
    ...
    public static final boolean isAtLeastT() {
        int i = Build.VERSION.SDK_INT;
        if (i < 33) {
            if (i < 32 || !isAtLeastPreReleaseCodename("Tiramisu", Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
    ...
    public static final boolean isAtLeastU() {
        int i = Build.VERSION.SDK_INT;
        if (i < 34) {
            if (i < 33 || !isAtLeastPreReleaseCodename("UpsideDownCake", Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
    ...
    public static final boolean isAtLeastV() {
        int i = Build.VERSION.SDK_INT;
        if (i < 35) {
            if (i < 34 || !isAtLeastPreReleaseCodename("VanillaIceCream", Build.VERSION.CODENAME)) {
                return false;
            }
            return true;
        }
