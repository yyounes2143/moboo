...
public class DifferentialMotionFlingController {
    ...
    public DifferentialMotionFlingController(Context context, DifferentialMotionFlingTarget differentialMotionFlingTarget) {
        this(context, differentialMotionFlingTarget, new FlingVelocityThresholdCalculator() { // from class: androidx.core.view.Wwwwwwwwwwwwwwwwww
        ...
        }, new DifferentialVelocityProvider() { // from class: androidx.core.view.Wwwwwwwwwwwwwwwww
