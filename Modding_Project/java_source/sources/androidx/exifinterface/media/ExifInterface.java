    ...
    */
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        for (int i3 = 0; i3 < EXIF_TAGS.length; i3++) {
            Object[] array = this.mAttributes[i3].entrySet().toArray();
        ...
        if (!this.mAttributes[i5].isEmpty()) {
            this.mAttributes[0].put(EXIF_POINTER_TAGS[i5].name, ExifAttribute.createULong(0L, this.mExifByteOrder));
        }
        if (!this.mAttributes[2].isEmpty()) {
            this.mAttributes[0].put(EXIF_POINTER_TAGS[2].name, ExifAttribute.createULong(0L, this.mExifByteOrder));
        }
        if (!this.mAttributes[3].isEmpty()) {
            this.mAttributes[i5].put(EXIF_POINTER_TAGS[3].name, ExifAttribute.createULong(0L, this.mExifByteOrder));
        }
        if (this.mHasThumbnail) {
            if (this.mHasThumbnailStrips) {
        ...
        for (int i9 = 0; i9 < EXIF_TAGS.length; i9++) {
            if (!this.mAttributes[i9].isEmpty()) {
                iArr[i9] = i8;
                i8 += (this.mAttributes[i9].size() * 12) + 6 + iArr2[i9];
            }
        }
        if (this.mHasThumbnail) {
            if (this.mHasThumbnailStrips) {
                this.mAttributes[4].put(TAG_STRIP_OFFSETS, ExifAttribute.createUShort(i8, this.mExifByteOrder));
            } else {
                this.mAttributes[4].put(TAG_JPEG_INTERCHANGE_FORMAT, ExifAttribute.createULong(i8, this.mExifByteOrder));
            }
            this.mThumbnailOffset = i8;
        ...
        if (DEBUG) {
            for (int i10 = 0; i10 < EXIF_TAGS.length; i10++) {
                ...
                Integer valueOf3 = Integer.valueOf(this.mAttributes[i10].size());
                Integer valueOf4 = Integer.valueOf(iArr2[i10]);
                ...
                objArr[3] = valueOf4;
                objArr[4] = valueOf5;
                String.format("index: %d, offsets: %d, tag count: %d, data sizes: %d, total size: %d", objArr);
            }
        }
        if (!this.mAttributes[i5].isEmpty()) {
            this.mAttributes[0].put(EXIF_POINTER_TAGS[i5].name, ExifAttribute.createULong(iArr[i5], this.mExifByteOrder));
        }
        if (!this.mAttributes[2].isEmpty()) {
            this.mAttributes[0].put(EXIF_POINTER_TAGS[2].name, ExifAttribute.createULong(iArr[2], this.mExifByteOrder));
        }
        if (!this.mAttributes[3].isEmpty()) {
            this.mAttributes[i5].put(EXIF_POINTER_TAGS[3].name, ExifAttribute.createULong(iArr[3], this.mExifByteOrder));
        }
        ...
        for (int i12 = 0; i12 < EXIF_TAGS.length; i12++) {
            if (!this.mAttributes[i12].isEmpty()) {
                ...
                for (Map.Entry<String, ExifAttribute> entry3 : this.mAttributes[i12].entrySet()) {
                    int i13 = sExifTagMapsForWriting[i12].get(entry3.getKey()).number;
                ...
                for (Map.Entry<String, ExifAttribute> entry4 : this.mAttributes[i12].entrySet()) {
    ...
    */
    public byte[] getThumbnailBytes() {
        ...
        L3b:
            ...
            java.io.FileDescriptor r0 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r0)     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
            int r2 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L78
            r3 = 0
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r0, r3, r2)     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L78
                                ...
                                if (i7 != i4 && i7 != 7 && i7 != i3) {
                                    if (DEBUG) {
                                        ...
                                        if (((Integer) guessDataFormat.second).intValue() != -1) {
                                            ...
                                            sb2.append(", ");
                                            sb2.append(strArr[((Integer) guessDataFormat.second).intValue()]);
                                        }
                                    }
                                } else {
                                    i = i7;
                        ...
                        switch (i) {
                            ...
                            case 5:
                                ...
                                for (int i10 = 0; i10 < split3.length; i10++) {
                                    ...
                                    rationalArr[i10] = new Rational((long) Double.parseDouble(split4[0]), (long) Double.parseDouble(split4[i2]));
                                }
