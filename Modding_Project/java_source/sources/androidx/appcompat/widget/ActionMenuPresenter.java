...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z4 || i8 + i7 > i5)) {
            i5--;
        }
        int i10 = i5 - i7;
        ...
        while (i12 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if ((i10 > 0 || z5) && i6 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i3 > 0)) {
                    z2 = true;
                } else {
                    z2 = false;
                }
                ...
                if (z2) {
                    ...
                    if (!actionMenuPresenter.mStrictWidthLimit ? i6 + i13 > 0 : i6 >= 0) {
                        z3 = true;
                    } else {
                        z3 = false;
                    }
