...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            paddingLeft = AbsActionBarView.next(next + positionChild(this.mClose, next, paddingTop, paddingTop2, isLayoutRtl), i7, isLayoutRtl);
        }
        int i8 = paddingLeft;
        ...
        if (actionMenuView != null) {
            positionChild(actionMenuView, i9, paddingTop, paddingTop2, !isLayoutRtl);
        }
    }
