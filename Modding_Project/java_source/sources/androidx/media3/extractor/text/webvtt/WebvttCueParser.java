...
public final class WebvttCueParser {
    ...
    public static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = new Comparator() { // from class: androidx.media3.extractor.text.webvtt.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
