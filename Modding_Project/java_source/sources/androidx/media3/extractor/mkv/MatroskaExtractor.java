...
public class MatroskaExtractor implements Extractor {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        @Override // androidx.media3.extractor.ExtractorsFactory
        public final Extractor[] createExtractors() {
            return MatroskaExtractor.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww();
        }
    ...
    public static final class Track {
        ...
        public void initializeOutput(ExtractorOutput extractorOutput, int i) throws ParserException {
            ...
            String str5 = str4;
            int i10 = (this.flagForced ? 2 : i2) | (this.flagDefault ? 1 : 0);
            ...
            if (MimeTypes.isAudio(str5)) {
                ...
                float f = (this.displayWidth == i6 || (i8 = this.displayHeight) == i6) ? -1.0f : (this.height * i7) / (this.width * i8);
            ...
            Format build2 = builder.setId(i).setSampleMimeType(str5).setMaxInputSize(i4).setLanguage(this.language).setSelectionFlags(i10).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
    ...
    */
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
                return MatroskaExtractor.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(SubtitleParser.Factory.this);
            }
            ...
            public /* synthetic */ ExtractorsFactory setSubtitleParserFactory(SubtitleParser.Factory factory2) {
                return Wwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this, factory2);
            }
    ...
    */
    ...
    @CallSuper
    public boolean isLevel1Element(int i) {
        if (i != 357149030 && i != ID_CLUSTER && i != ID_CUES && i != ID_TRACKS) {
            return false;
        }
        return true;
    }
