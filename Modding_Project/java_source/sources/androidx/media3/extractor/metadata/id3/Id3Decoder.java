...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = new FramePredicate() { // from class: androidx.media3.extractor.metadata.id3.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        @Override // androidx.media3.extractor.metadata.id3.Id3Decoder.FramePredicate
        public final boolean evaluate(int i, int i2, int i3, int i4, int i5) {
            return Id3Decoder.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(i, i2, i3, i4, i5);
        }
    };
