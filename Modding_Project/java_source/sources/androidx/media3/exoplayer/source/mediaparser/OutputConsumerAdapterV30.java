...
public final class OutputConsumerAdapterV30 implements MediaParser$OutputConsumer {
    ...
    public static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            int read;
            read = Wwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Util.castNonNull(this.input)).read(bArr, i, i2);
            return read;
        }
    }
    ...
    public static final class SeekMapAdapter implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            if (obj == seekPoints.second) {
                return new SeekMap.SeekPoints(asExoPlayerSeekPoint(androidx.media3.exoplayer.source.Wwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(obj)));
            }
            return new SeekMap.SeekPoints(asExoPlayerSeekPoint(androidx.media3.exoplayer.source.Wwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(obj)), asExoPlayerSeekPoint(androidx.media3.exoplayer.source.Wwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(seekPoints.second)));
        }
