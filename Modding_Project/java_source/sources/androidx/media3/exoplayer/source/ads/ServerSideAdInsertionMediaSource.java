...
import androidx.media3.exoplayer.drm.Wwwwwwwwwwwwwwwwwwwwwwwww;
...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            if (window.durationUs == -9223372036854775807L) {
                ...
                window.durationUs = period3.positionInWindowUs + ServerSideAdInsertionUtil.getMediaPeriodPositionUsForContent(window.durationUs - j3, -1, (AdPlaybackState) Assertions.checkNotNull(this.adPlaybackStates.get(period2.uid)));
            }
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ServerSideAdInsertionMediaSource serverSideAdInsertionMediaSource, ImmutableMap immutableMap, Timeline timeline) {
        ...
        synchronized (this) {
            try {
                ...
                if (handler == null) {
                    ...
                    handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.Wwwwwwwwwwwwwwwwwwwwwwwwwwww
                        @Override // java.lang.Runnable
                        public final void run() {
                            ServerSideAdInsertionMediaSource.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ServerSideAdInsertionMediaSource.this, immutableMap, timeline);
                        }
                    });
                }
            } catch (Throwable th) {
