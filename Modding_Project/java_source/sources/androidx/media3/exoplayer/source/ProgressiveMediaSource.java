...
public final class ProgressiveMediaSource extends BaseMediaSource implements ProgressiveMediaPeriod.Listener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public static /* synthetic */ ProgressiveMediaExtractor Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ExtractorsFactory extractorsFactory, PlayerId playerId) {
        ...
        public Factory(DataSource.Factory factory, final ExtractorsFactory extractorsFactory) {
            this(factory, new ProgressiveMediaExtractor.Factory() { // from class: androidx.media3.exoplayer.source.Wwwww
                @Override // androidx.media3.exoplayer.source.ProgressiveMediaExtractor.Factory
                public final ProgressiveMediaExtractor createProgressiveMediaExtractor(PlayerId playerId) {
                    return ProgressiveMediaSource.Factory.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ExtractorsFactory.this, playerId);
                }
            });
        }
    ...
    public boolean canUpdateMediaItem(MediaItem mediaItem) {
        ...
        if (localConfiguration2 != null && localConfiguration2.uri.equals(localConfiguration.uri) && localConfiguration2.imageDurationMs == localConfiguration.imageDurationMs && Util.areEqual(localConfiguration2.customCacheKey, localConfiguration.customCacheKey)) {
            return true;
        }
        return false;
    }
