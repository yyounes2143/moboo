    ...
    private static int findRenderer(RendererCapabilities[] rendererCapabilitiesArr, TrackGroup trackGroup, int[] iArr, boolean z) throws ExoPlaybackException {
        ...
        for (int i2 = 0; i2 < rendererCapabilitiesArr.length; i2++) {
            ...
            for (int i4 = 0; i4 < trackGroup.length; i4++) {
                i3 = Math.max(i3, O000000.Wwwwwwwwwwwwwwwwwwwwwwww(rendererCapabilities.supportsFormat(trackGroup.getFormat(i4))));
            }
            if (iArr[i2] == 0) {
                z2 = true;
            } else {
    ...
    public static final class MappedTrackInfo {
        ...
        public int getRendererSupport(int i) {
            ...
            for (int[] iArr2 : this.rendererFormatSupports[i]) {
                for (int i3 : iArr2) {
                    int Wwwwwwwwwwwwwwwwwwwwwwww2 = O000000.Wwwwwwwwwwwwwwwwwwwwwwww(i3);
                    int i4 = 1;
                    if (Wwwwwwwwwwwwwwwwwwwwwwww2 != 0 && Wwwwwwwwwwwwwwwwwwwwwwww2 != 1 && Wwwwwwwwwwwwwwwwwwwwwwww2 != 2) {
        ...
        public int getTrackSupport(int i, int i2, int i3) {
            return O000000.Wwwwwwwwwwwwwwwwwwwwwwww(getCapabilities(i, i2, i3));
        }
        ...
        public int getAdaptiveSupport(int i, int i2, int[] iArr) {
            ...
            while (i3 < iArr.length) {
                ...
                i4 = Math.min(i4, O000000.Wwwwwwwwwwwwwwwwwwwwwwwwwww(this.rendererFormatSupports[i][i2][i3]));
                i3++;
                i5 = i6;
            }
