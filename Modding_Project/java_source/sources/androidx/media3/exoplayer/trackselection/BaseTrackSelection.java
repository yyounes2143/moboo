...
public abstract class BaseTrackSelection implements ExoTrackSelection {
    ...
    public static /* synthetic */ int Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(Format format, Format format2) {
    ...
    public /* synthetic */ long getLatestBitrateEstimate() {
        return Wwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this);
    }
    ...
    public /* synthetic */ void onDiscontinuity() {
        Wwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this);
    }

    @Override // androidx.media3.exoplayer.trackselection.ExoTrackSelection
    public /* synthetic */ void onPlayWhenReadyChanged(boolean z) {
        Wwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this, z);
    }

    @Override // androidx.media3.exoplayer.trackselection.ExoTrackSelection
    public /* synthetic */ void onRebuffer() {
        Wwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this);
    }

    @Override // androidx.media3.exoplayer.trackselection.ExoTrackSelection
    public /* synthetic */ boolean shouldCancelChunkLoad(long j, Chunk chunk, List list) {
        return Wwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this, j, chunk, list);
    }
    ...
    public BaseTrackSelection(TrackGroup trackGroup, int[] iArr, int i) {
        ...
        Arrays.sort(this.formats, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return BaseTrackSelection.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww((Format) obj, (Format) obj2);
            }
        });
