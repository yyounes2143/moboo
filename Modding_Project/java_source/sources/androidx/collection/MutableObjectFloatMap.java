...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k, @NotNull Function0<Float> function0) {
    ...
    public final void plusAssign(@NotNull ObjectFloatMap<K> objectFloatMap) {
    ...
    public final void putAll(@NotNull ObjectFloatMap<K> objectFloatMap) {
    ...
    public final void removeIf(@NotNull Function2<? super K, ? super Float, Boolean> function2) {
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
