...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final long getOrPut(int i, @NotNull Function0<Long> function0) {
    ...
    public final void plusAssign(@NotNull IntLongMap intLongMap) {
        putAll(intLongMap);
    }
    ...
    public final void putAll(@NotNull IntLongMap intLongMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Integer, ? super Long, Boolean> function2) {
        long[] jArr = this.metadata;
