...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public final float getOrPut(int i, @NotNull Function0<Float> function0) {
    ...
    public final void plusAssign(@NotNull IntFloatMap intFloatMap) {
        putAll(intFloatMap);
    }
    ...
    public final void removeIf(@NotNull Function2<? super Integer, ? super Float, Boolean> function2) {
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
