...
public abstract class LongIntMap {
    ...
    public final boolean all(@NotNull Function2<? super Long, ? super Integer, Boolean> function2) {
        long[] jArr = this.keys;
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (!function2.invoke(Long.valueOf(jArr[i4]), Integer.valueOf(iArr[i4])).booleanValue()) {
                                return false;
                            }
                        }
                        j >>= 8;
    ...
    public final void forEach(@NotNull Function2<? super Long, ? super Integer, Unit> function2) {
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    public final int getOrElse(long j, @NotNull Function0<Integer> function0) {
        int findKeyIndex = findKeyIndex(j);
        if (findKeyIndex < 0) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128) {
                        int i5 = (i << 3) + i4;
                        i2 += iArr[i5] ^ Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(jArr[i5]);
                    }
                    j >>= 8;
                }
                if (i3 != 8) {
    ...
    public final boolean any(@NotNull Function2<? super Long, ? super Integer, Boolean> function2) {
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    public final int count(@NotNull Function2<? super Long, ? super Integer, Boolean> function2) {
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128) {
                        int i5 = (i << 3) + i4;
                        if (function2.invoke(Long.valueOf(jArr[i5]), Integer.valueOf(iArr[i5])).booleanValue()) {
                            i2++;
                        }
                    }
                    j >>= 8;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull CharSequence charSequence4, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i2;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.keys;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((255 & j) < 128) {
                            ...
                            sb.append(function2.invoke(Long.valueOf(j2), Integer.valueOf(i9)));
                            i4++;
                        } else {
                            i2 = i5;
                        }
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i2;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.keys;
