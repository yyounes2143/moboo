...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    public final int getOrPut(float f, @NotNull Function0<Integer> function0) {
    ...
    public final void plusAssign(@NotNull FloatIntMap floatIntMap) {
        putAll(floatIntMap);
    }
    ...
    public final void putAll(@NotNull FloatIntMap floatIntMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Float, ? super Integer, Boolean> function2) {
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
