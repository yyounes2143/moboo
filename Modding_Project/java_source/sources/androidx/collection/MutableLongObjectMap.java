...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    private final int findAbsoluteInsertIndex(long j) {
        ...
        int i2 = Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 ^ (Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 << 16);
        int i3 = i2 >>> 7;
        int i4 = i2 & 127;
    ...
    private final void resizeStorage(int i) {
        ...
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                long j = jArr3[i3];
                int Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 = Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(j) * ScatterMapKt.MurmurHashC1;
                int i4 = Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 ^ (Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2 << 16);
    ...
    public final V getOrPut(long j, @NotNull Function0<? extends V> function0) {
        V v = get(j);
        if (v == null) {
    ...
    public final void plusAssign(@NotNull LongObjectMap<V> longObjectMap) {
    ...
    public final void putAll(@NotNull LongObjectMap<V> longObjectMap) {
    ...
    */
    ...
    public final void removeIf(@NotNull Function2<? super Long, ? super V, Boolean> function2) {
        long[] jArr = this.metadata;
