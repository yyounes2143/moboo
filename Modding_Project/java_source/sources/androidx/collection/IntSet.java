...
public abstract class IntSet {
    ...
    public final boolean all(@NotNull Function1<? super Integer, Boolean> function1) {
    ...
    public final int count(@NotNull Function1<? super Integer, Boolean> function1) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                int i3 = 8 - ((~(i - length)) >>> 31);
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128 && function1.invoke(Integer.valueOf(iArr[(i << 3) + i4])).booleanValue()) {
                        i2++;
                    }
                    j >>= 8;
                }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i7 < i6) {
                        if ((255 & j) < 128) {
                            ...
                            i2 = i5;
                            sb.append(function1.invoke(Integer.valueOf(i8)));
                            i4++;
                        } else {
                            i2 = i5;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((255 & j) < 128) {
                            ...
                            sb.append(function1.invoke(Integer.valueOf(i5)));
                            i2++;
                        }
                        j >>= 8;
                    }
