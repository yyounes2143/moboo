...
public abstract class IntList {
    ...
    public final boolean containsAll(@NotNull IntList intList) {
    ...
    public final int elementAtOrElse(@androidx.annotation.IntRange(from = 0) int i, @NotNull Function1<? super Integer, Integer> function1) {
        if (i >= 0 && i < this._size) {
            return this.content[i];
        }
    ...
    public final <R> R fold(R r, @NotNull Function2<? super R, ? super Integer, ? extends R> function2) {
        int[] iArr = this.content;
        int i = this._size;
    ...
    public final <R> R foldIndexed(R r, @NotNull Function3<? super Integer, ? super R, ? super Integer, ? extends R> function3) {
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            R r2 = r;
            r = function3.invoke(Integer.valueOf(i2), r2, Integer.valueOf(iArr[i2]));
        }
        return r;
    }

    public final <R> R foldRight(R r, @NotNull Function2<? super Integer, ? super R, ? extends R> function2) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final <R> R foldRightIndexed(R r, @NotNull Function3<? super Integer, ? super Integer, ? super R, ? extends R> function3) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
            ...
            r = function3.invoke(Integer.valueOf(i), Integer.valueOf(iArr[i]), r);
        }
    }
    ...
    public final void forEachIndexed(@NotNull Function2<? super Integer, ? super Integer, Unit> function2) {
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public final void forEachReversed(@NotNull Function1<? super Integer, Unit> function1) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final void forEachReversedIndexed(@NotNull Function2<? super Integer, ? super Integer, Unit> function2) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final int indexOfFirst(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public final int indexOfLast(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final boolean reversedAny(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
    ...
    public final boolean any(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            if (function1.invoke(Integer.valueOf(iArr[i2])).booleanValue()) {
    ...
    public final int count(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        int i2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
    ...
    public final int first(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = iArr[i2];
    ...
    public final int last(@NotNull Function1<? super Integer, Boolean> function1) {
        int[] iArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull CharSequence charSequence4, @NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        int[] iArr = this.content;
        int i2 = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        int[] iArr = this.content;
        int i2 = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, @NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        int[] iArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        int[] iArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        int[] iArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull Function1<? super Integer, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        int[] iArr = this.content;
        int i = this._size;
