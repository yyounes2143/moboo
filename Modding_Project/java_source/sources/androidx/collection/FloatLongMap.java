...
public abstract class FloatLongMap {
    ...
    public final boolean all(@NotNull Function2<? super Float, ? super Long, Boolean> function2) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (!function2.invoke(Float.valueOf(fArr[i4]), Long.valueOf(jArr[i4])).booleanValue()) {
                                return false;
                            }
                        }
                        j >>= 8;
    ...
    public final void forEach(@NotNull Function2<? super Float, ? super Long, Unit> function2) {
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    public final long getOrElse(float f, @NotNull Function0<Long> function0) {
        int findKeyIndex = findKeyIndex(f);
        if (findKeyIndex < 0) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128) {
                        int i5 = (i << 3) + i4;
                        i2 += Float.floatToIntBits(fArr[i5]) ^ Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(jArr[i5]);
                    }
                    j >>= 8;
                }
                if (i3 != 8) {
    ...
    public final boolean any(@NotNull Function2<? super Float, ? super Long, Boolean> function2) {
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
    ...
    public final int count(@NotNull Function2<? super Float, ? super Long, Boolean> function2) {
        float[] fArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
        int length = jArr2.length - 2;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128) {
                        int i5 = (i << 3) + i4;
                        if (function2.invoke(Float.valueOf(fArr[i5]), Long.valueOf(jArr[i5])).booleanValue()) {
                            i2++;
                        }
                    }
                    j >>= 8;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull CharSequence charSequence4, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        float[] fArr;
        float[] fArr2;
        int i2;
        StringBuilder sb = new StringBuilder();
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        int i2;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        float[] fArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        float[] fArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        float[] fArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        float[] fArr = this.keys;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull Function2<? super Float, ? super Long, ? extends CharSequence> function2) {
        int i;
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        float[] fArr = this.keys;
