...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public final int getOrPut(int i, @NotNull Function0<Integer> function0) {
    ...
    public final void plusAssign(@NotNull IntIntMap intIntMap) {
        putAll(intIntMap);
    }
    ...
    public final void putAll(@NotNull IntIntMap intIntMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Integer, ? super Integer, Boolean> function2) {
        long[] jArr = this.metadata;
        int length = jArr.length - 2;
        if (length >= 0) {
            int i = 0;
