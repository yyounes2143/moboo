...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final long getOrPut(K k, @NotNull Function0<Long> function0) {
    ...
    public final void plusAssign(@NotNull ObjectLongMap<K> objectLongMap) {
    ...
    public final void putAll(@NotNull ObjectLongMap<K> objectLongMap) {
    ...
    public final void removeIf(@NotNull Function2<? super K, ? super Long, Boolean> function2) {
        long[] jArr = this.metadata;
