...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public final int getOrPut(long j, @NotNull Function0<Integer> function0) {
    ...
    public final void plusAssign(@NotNull LongIntMap longIntMap) {
        putAll(longIntMap);
    }
    ...
    public final void putAll(@NotNull LongIntMap longIntMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Long, ? super Integer, Boolean> function2) {
        long[] jArr = this.metadata;
