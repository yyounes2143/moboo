...
public final class MutableLongSet extends LongSet {
    ...
    */
    ...
    public final boolean addAll(@NotNull LongSet longSet) {
        int i = this._size;
        plusAssign(longSet);
        return i != this._size;
    }

    public final boolean removeAll(@NotNull LongSet longSet) {
        int i = this._size;
        minusAssign(longSet);
        return i != this._size;
    }

    public final void plusAssign(@NotNull LongSet longSet) {
