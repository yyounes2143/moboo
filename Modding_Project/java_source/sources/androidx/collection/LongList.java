...
public abstract class LongList {
    ...
    public final long elementAtOrElse(@androidx.annotation.IntRange(from = 0) int i, @NotNull Function1<? super Integer, Long> function1) {
        if (i >= 0 && i < this._size) {
            return this.content[i];
        }
    ...
    public final <R> R fold(R r, @NotNull Function2<? super R, ? super Long, ? extends R> function2) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            r = function2.invoke(r, Long.valueOf(jArr[i2]));
        }
        return r;
    }

    public final <R> R foldIndexed(R r, @NotNull Function3<? super Integer, ? super R, ? super Long, ? extends R> function3) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            R r2 = r;
            r = function3.invoke(Integer.valueOf(i2), r2, Long.valueOf(jArr[i2]));
        }
        return r;
    }

    public final <R> R foldRight(R r, @NotNull Function2<? super Long, ? super R, ? extends R> function2) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
            ...
            r = function2.invoke(Long.valueOf(jArr[i]), r);
        }
    }

    public final <R> R foldRightIndexed(R r, @NotNull Function3<? super Integer, ? super Long, ? super R, ? extends R> function3) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
            ...
            r = function3.invoke(Integer.valueOf(i), Long.valueOf(jArr[i]), r);
        }
    }
    ...
    public final void forEachIndexed(@NotNull Function2<? super Integer, ? super Long, Unit> function2) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public final void forEachReversed(@NotNull Function1<? super Long, Unit> function1) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final void forEachReversedIndexed(@NotNull Function2<? super Integer, ? super Long, Unit> function2) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public int hashCode() {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            i2 += Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(jArr[i3]) * 31;
        }
        return i2;
    }
    ...
    public final int indexOfFirst(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public final int indexOfLast(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    public final boolean reversedAny(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
    ...
    public final boolean any(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            if (function1.invoke(Long.valueOf(jArr[i2])).booleanValue()) {
    ...
    public final int count(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        int i2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
    ...
    public final long first(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        for (int i2 = 0; i2 < i; i2++) {
            long j = jArr[i2];
    ...
    public final long last(@NotNull Function1<? super Long, Boolean> function1) {
        long[] jArr = this.content;
        int i = this._size;
        while (true) {
            i--;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull CharSequence charSequence4, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.content;
        int i2 = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int i, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.content;
        int i2 = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append(charSequence2);
        long[] jArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.content;
        int i = this._size;
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull Function1<? super Long, ? extends CharSequence> function1) {
        StringBuilder sb = new StringBuilder();
        sb.append((CharSequence) "");
        long[] jArr = this.content;
        int i = this._size;
