...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final long getOrPut(float f, @NotNull Function0<Long> function0) {
    ...
    public final void plusAssign(@NotNull FloatLongMap floatLongMap) {
        putAll(floatLongMap);
    }
    ...
    public final void putAll(@NotNull FloatLongMap floatLongMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Float, ? super Long, Boolean> function2) {
        long[] jArr = this.metadata;
