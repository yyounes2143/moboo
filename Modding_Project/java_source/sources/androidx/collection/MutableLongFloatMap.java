...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final float getOrPut(long j, @NotNull Function0<Float> function0) {
    ...
    public final void plusAssign(@NotNull LongFloatMap longFloatMap) {
        putAll(longFloatMap);
    }
    ...
    public final void putAll(@NotNull LongFloatMap longFloatMap) {
    ...
    public final void removeIf(@NotNull Function2<? super Long, ? super Float, Boolean> function2) {
        long[] jArr = this.metadata;
