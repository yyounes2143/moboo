...
public class ViewTransition {
    ...
    public static /* synthetic */ void Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ViewTransition viewTransition, View[] viewArr) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (i2 < size) {
                ...
                i2++;
                keyFrames2.addKey(key.mo29clone().setViewId(id));
            }
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, final View... viewArr) {
        ...
        motionLayout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
            @Override // java.lang.Runnable
            public final void run() {
                ViewTransition.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(ViewTransition.this, viewArr);
            }
        });
    }
