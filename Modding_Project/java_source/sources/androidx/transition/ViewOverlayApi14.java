    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public ViewParent invalidateChildInParent(int[] iArr, Rect rect) {
            if (this.mHostView != null) {
                ...
                if (Wwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.mHostView)) {
                    iArr[0] = 0;
                    iArr[1] = 0;
                    int[] iArr2 = new int[2];
                    getOffset(iArr2);
        ...
        public ViewParent invalidateChildInParentFast(int i, int i2, Rect rect) {
            if (Wwwwwwwwwwwwwwwww.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(this.mHostView) && sInvalidateChildInParentFastMethod != null) {
                try {
                    getOffset(new int[2]);
