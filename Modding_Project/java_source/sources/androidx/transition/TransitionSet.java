...
public class TransitionSet extends Transition {
    ...
    public void runAnimators() {
        ...
        int size = arrayList.size();
        while (i < size) {
            Transition transition3 = arrayList.get(i);
            i++;
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo180clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo180clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo180clone());
        }
