            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (this.mMainHandlerLoadCallback == null) {
                        this.mMainHandlerLoadCallback = new Runnable() { // from class: androidx.emoji2.text.Wwwwwwwwwwwwwwwwwwwwwwwwwwwww
        ...
        public void loadInternal() {
            synchronized (this.mLock) {
                try {
                    ...
                    this.mExecutor.execute(new Runnable() { // from class: androidx.emoji2.text.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww
                        @Override // java.lang.Runnable
                        public final void run() {
