...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public CharSequence deserialize(@NotNull Decoder decoder) {
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m70getCharSequenceimpl(SavedStateReader.m53constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull CharSequence charSequence) {
        if (encoder instanceof SavedStateEncoder) {
            SavedStateEncoder savedStateEncoder = (SavedStateEncoder) encoder;
            SavedStateWriter.m149putCharSequenceimpl(SavedStateWriter.m139constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), charSequence);
            return;
        }
