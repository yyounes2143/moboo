...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public Parcelable[] deserialize(@NotNull Decoder decoder) {
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m101getParcelableArrayimpl(SavedStateReader.m53constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull Parcelable[] parcelableArr) {
        if (encoder instanceof SavedStateEncoder) {
            SavedStateEncoder savedStateEncoder = (SavedStateEncoder) encoder;
            SavedStateWriter.m164putParcelableArrayimpl(SavedStateWriter.m139constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), parcelableArr);
            return;
        }
