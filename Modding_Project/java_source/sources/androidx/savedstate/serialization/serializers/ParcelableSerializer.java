...
public abstract class ParcelableSerializer<T extends Parcelable> implements KSerializer<T> {
    ...
    public final T deserialize(@NotNull Decoder decoder) {
        if (decoder instanceof SavedStateDecoder) {
            ...
            return (T) SavedStateReader.m99getParcelableimpl(SavedStateReader.m53constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
        }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull T t) {
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m163putParcelableimpl(SavedStateWriter.m139constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), t);
            return;
        }
