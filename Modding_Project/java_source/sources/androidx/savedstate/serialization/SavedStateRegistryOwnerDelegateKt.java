...
public final class SavedStateRegistryOwnerDelegateKt {
    ...
    @NotNull
    public static final <T> ReadWriteProperty<Object, T> saved(@NotNull SavedStateRegistryOwner savedStateRegistryOwner, @NotNull KSerializer<T> kSerializer, @Nullable String str, @NotNull SavedStateConfiguration savedStateConfiguration, @NotNull Function0<? extends T> function0) {
