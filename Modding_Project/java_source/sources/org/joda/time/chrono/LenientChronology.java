...
public final class LenientChronology extends AssembledChronology {
    ...
    public transient Chronology f13777Kkkkkkkkkkkkk;
    ...
    public final DateTimeField Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(DateTimeField dateTimeField) {
    ...
    public Chronology withUTC() {
        if (this.f13777Kkkkkkkkkkkkk == null) {
            if (getZone() == DateTimeZone.UTC) {
                this.f13777Kkkkkkkkkkkkk = this;
            } else {
                this.f13777Kkkkkkkkkkkkk = getInstance(getBase().withUTC());
            }
        }
        return this.f13777Kkkkkkkkkkkkk;
    }
