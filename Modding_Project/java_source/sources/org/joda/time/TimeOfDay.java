...
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
    ...
    public static final DateTimeFieldType[] f13646Wwwwwwwwwwwwwwwwwwwwwwwww = {DateTimeFieldType.hourOfDay(), DateTimeFieldType.minuteOfHour(), DateTimeFieldType.secondOfMinute(), DateTimeFieldType.millisOfSecond()};
    ...
    public DateTimeFieldType getFieldType(int i) {
        return f13646Wwwwwwwwwwwwwwwwwwwwwwwww[i];
    }

    @Override // org.joda.time.base.AbstractPartial
    public DateTimeFieldType[] getFieldTypes() {
        return (DateTimeFieldType[]) f13646Wwwwwwwwwwwwwwwwwwwwwwwww.clone();
    }
    ...
    public TimeOfDay minusHours(int i) {
        return withFieldAdded(DurationFieldType.hours(), FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwww(i));
    }

    public TimeOfDay minusMillis(int i) {
        return withFieldAdded(DurationFieldType.millis(), FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwww(i));
    }

    public TimeOfDay minusMinutes(int i) {
        return withFieldAdded(DurationFieldType.minutes(), FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwww(i));
    }

    public TimeOfDay minusSeconds(int i) {
        return withFieldAdded(DurationFieldType.seconds(), FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwww(i));
    }
    ...
    public String toString() {
        return ISODateTimeFormat.Wwwwwwwwwwwwwwwwwwww().Wwwwwwwwwwwwwwwwwwwwwww(this);
    }
    ...
    public TimeOfDay withPeriodAdded(ReadablePeriod readablePeriod, int i) {
        if (readablePeriod != null && i != 0) {
            ...
            for (int i2 = 0; i2 < readablePeriod.size(); i2++) {
                ...
                if (indexOf >= 0) {
                    values = getField(indexOf).addWrapPartial(this, indexOf, values, FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwww(readablePeriod.getValue(i2), i));
                }
            }
    ...
    public static TimeOfDay fromMillisOfDay(long j, Chronology chronology) {
        return new TimeOfDay(j, DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(chronology).withUTC());
    }
    ...
    public TimeOfDay(Object obj) {
        super(obj, null, ISODateTimeFormat.Wwwwwwwwwwwwwwwww());
    }

    public TimeOfDay(Object obj, Chronology chronology) {
        super(obj, DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(chronology), ISODateTimeFormat.Wwwwwwwwwwwwwwwww());
    }
