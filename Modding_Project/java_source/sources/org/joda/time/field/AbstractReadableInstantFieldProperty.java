...
public abstract class AbstractReadableInstantFieldProperty implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (get() == abstractReadableInstantFieldProperty.get() && getFieldType().equals(abstractReadableInstantFieldProperty.getFieldType()) && FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(getChronology(), abstractReadableInstantFieldProperty.getChronology())) {
            return true;
        }
        return false;
    }
    ...
    public int getDifference(ReadableInstant readableInstant) {
        if (readableInstant == null) {
            return getField().getDifference(getMillis(), DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww());
        }
    ...
    public long getDifferenceAsLong(ReadableInstant readableInstant) {
        if (readableInstant == null) {
            return getField().getDifferenceAsLong(getMillis(), DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww());
        }
