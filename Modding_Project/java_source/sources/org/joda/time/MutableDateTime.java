...
public class MutableDateTime extends BaseDateTime implements ReadWritableDateTime, Cloneable, Serializable {
    ...
    public static MutableDateTime parse(String str) {
        return parse(str, ISODateTimeFormat.Wwwwwwwwwwwwwwwwwwwwwwwwww().Wwwwwwwwwwww());
    }

    public void add(long j) {
        setMillis(FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwww(getMillis(), j));
    }
    ...
    public void setZone(DateTimeZone dateTimeZone) {
        ...
        if (chronology.getZone() != Wwwwwwwwwwwwwwwwwwwwww2) {
            setChronology(chronology.withZone(Wwwwwwwwwwwwwwwwwwwwww2));
        }
    }

    public void setZoneRetainFields(DateTimeZone dateTimeZone) {
        DateTimeZone Wwwwwwwwwwwwwwwwwwwwww2 = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwww(dateTimeZone);
        DateTimeZone Wwwwwwwwwwwwwwwwwwwwww3 = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwww(getZone());
        if (Wwwwwwwwwwwwwwwwwwwwww2 == Wwwwwwwwwwwwwwwwwwwwww3) {
            return;
        }
        long millisKeepLocal = Wwwwwwwwwwwwwwwwwwwwww3.getMillisKeepLocal(Wwwwwwwwwwwwwwwwwwwwww2, getMillis());
        setChronology(getChronology().withZone(Wwwwwwwwwwwwwwwwwwwwww2));
    ...
    public static MutableDateTime parse(String str, DateTimeFormatter dateTimeFormatter) {
        return dateTimeFormatter.Wwwwwwwwwwwwwwwwwwwwwwwwwwwww(str).toMutableDateTime();
    }
    ...
    public void setDate(ReadableInstant readableInstant) {
        ...
        if ((readableInstant instanceof ReadableDateTime) && (zone = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(((ReadableDateTime) readableInstant).getChronology()).getZone()) != null) {
            Wwwwwwwwwwwwwwwwwwwwwwwwwww2 = zone.getMillisKeepLocal(getZone(), Wwwwwwwwwwwwwwwwwwwwwwwwwww2);
        }
        setDate(Wwwwwwwwwwwwwwwwwwwwwwwwwww2);
    }
    ...
    public void add(ReadableDuration readableDuration, int i) {
        if (readableDuration != null) {
            add(FieldUtils.Wwwwwwwwwwwwwwwwwwwwwwwwww(readableDuration.getMillis(), i));
        }
    }

    public void setTime(ReadableInstant readableInstant) {
        long Wwwwwwwwwwwwwwwwwwwwwwwwwww2 = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwww(readableInstant);
        DateTimeZone zone = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwww(readableInstant).getZone();
        if (zone != null) {
            Wwwwwwwwwwwwwwwwwwwwwwwwwww2 = zone.getMillisKeepLocal(DateTimeZone.UTC, Wwwwwwwwwwwwwwwwwwwwwwwwwww2);
        }
        setTime(Wwwwwwwwwwwwwwwwwwwwwwwwwww2);
    }
    ...
    public void setMillis(ReadableInstant readableInstant) {
        setMillis(DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwww(readableInstant));
    }
    ...
    public MutableDateTime(Object obj, Chronology chronology) {
        super(obj, DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(chronology));
    }
