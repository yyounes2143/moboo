...
public abstract class DurationFieldType implements Serializable {
    ...
    public static class StandardDurationFieldType extends DurationFieldType {
        ...
        public DurationField getField(Chronology chronology) {
            ...
            switch (this.iOrdinal) {
                case 1:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.eras();
                case 2:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.centuries();
                case 3:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.weekyears();
                case 4:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.years();
                case 5:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.months();
                case 6:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.weeks();
                case 7:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.days();
                case 8:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.halfdays();
                case 9:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.hours();
                case 10:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.minutes();
                case 11:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.seconds();
                case 12:
                    return Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww2.millis();
                default:
