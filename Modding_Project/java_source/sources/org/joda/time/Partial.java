...
public final class Partial extends AbstractPartial implements ReadablePartial, Serializable {
    ...
    public transient DateTimeFormatter[] f13626Wwwwwwwwwwwwwwwwwwwwwwwww;
    ...
    public DateTimeFormatter getFormatter() {
        DateTimeFormatter[] dateTimeFormatterArr = this.f13626Wwwwwwwwwwwwwwwwwwwwwwwww;
        if (dateTimeFormatterArr == null) {
            ...
            try {
                ...
                dateTimeFormatterArr[0] = ISODateTimeFormat.Wwwwwwwwwwwwwwwwwwwwwwwww(arrayList, true, false);
                if (arrayList.size() == 0) {
                    dateTimeFormatterArr[1] = dateTimeFormatterArr[0];
                }
            } catch (IllegalArgumentException unused) {
            }
            this.f13626Wwwwwwwwwwwwwwwwwwwwwwwww = dateTimeFormatterArr;
        }
    ...
    public boolean isMatch(ReadableInstant readableInstant) {
        ...
        while (true) {
            ...
            if (dateTimeFieldTypeArr[i].getField(Wwwwwwwwwwwwwwwwwwwwwwwwwwww2).get(Wwwwwwwwwwwwwwwwwwwwwwwwwww2) != this.iValues[i]) {
                return false;
            }
            i++;
        }
    ...
    public String toString() {
        ...
        if (dateTimeFormatterArr == null) {
            getFormatter();
            dateTimeFormatterArr = this.f13626Wwwwwwwwwwwwwwwwwwwwwwwww;
            if (dateTimeFormatterArr == null) {
                return toStringList();
            }
        }
    ...
    public Partial(Chronology chronology) {
        this.iChronology = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(chronology).withUTC();
    ...
    public Partial(ReadablePartial readablePartial) {
        if (readablePartial != null) {
            this.iChronology = DateTimeUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(readablePartial.getChronology()).withUTC();
