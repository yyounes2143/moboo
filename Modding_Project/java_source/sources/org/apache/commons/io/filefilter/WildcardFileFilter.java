...
public class WildcardFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public boolean accept(File file, String str) {
        for (String str2 : this.wildcards) {
            if (FilenameUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwww(str, str2, this.caseSensitivity)) {
                return true;
            }
        }
        return false;
    ...
    public boolean accept(File file) {
        ...
        for (String str : this.wildcards) {
            if (FilenameUtils.Wwwwwwwwwwwwwwwwwwwwwwwwwwww(name, str, this.caseSensitivity)) {
                return true;
            }
        }
        return false;
