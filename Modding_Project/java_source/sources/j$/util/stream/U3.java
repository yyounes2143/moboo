...
public final class U3 extends AbstractC2208f0 implements Y3 {
    ...
    public final Spliterator L(AbstractC2182a abstractC2182a, Spliterator spliterator) {
        if (X2.ORDERED.l(abstractC2182a.f)) {
            return K(abstractC2182a, spliterator, new Z(22)).spliterator();
        }
        return new g4((j$.util.F) abstractC2182a.T(spliterator), 0);
    }
