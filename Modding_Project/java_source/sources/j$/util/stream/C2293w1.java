...
public final class C2293w1 implements N1, InterfaceC2210f2 {

    /* renamed from: a  reason: collision with root package name */
    public double f11931a;
    ...
    public C2293w1(double d, DoubleBinaryOperator doubleBinaryOperator) {
        this.b = d;
    ...
    public final void accept(double d) {
        this.f11931a = this.c.applyAsDouble(this.f11931a, d);
    }

    @Override // java.util.function.Supplier
    public final Object get() {
        return Double.valueOf(this.f11931a);
    }
}
